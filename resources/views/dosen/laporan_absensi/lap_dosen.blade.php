    ...
    <div class="w-full h-max max-w-full mt-5 p-8 bg-white rounded-sm shadow-xl">
      <div class="flex flex-col md:flex-row">
        ...
        <div class="flex flex-col w-full mb-4 md:w-1/3 mr-0 md:mr-8" 
             x-data="{ 
                ...
                selected: '', 
                loading: false, 
                options: ['2023/2024 1', '2023/2024 2', '2023/2024 3', '2023/2024 4', '2023/2024 5', '2023/2024 6', '2023/2024 7', '2023/2024 8'],
                get filtered() { 
                  return this.options.filter(o => o.toLowerCase().includes(this.search.toLowerCase())); 
                }
             }">
      ...
      <div class="flex flex-col gap-3 mt-3">
        <div class="flex flex-col md:flex-row items-start md:items-center gap-2">
          ...
          <input type="text" id="nip" disabled name="nip" class="border border-gray-300 bg-gray-300 rounded px-3 py-2 w-full sm:w-70" value="E09263742784292">
        </div>
        
        <div class="flex flex-col md:flex-row items-start md:items-center gap-2">
          <label for="nama" class="w-20 font-semibold">Nama:</label>
          <input type="text" id="nama" disabled name="nama" class="border border-gray-300 bg-gray-300 rounded px-3 py-2 w-full sm:w-70" value="Edwin Kurniawan">
        </div>
      </div>
