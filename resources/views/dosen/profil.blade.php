    ...
    <div>
      ...
      <div class="w-full flex flex-col md:flex-row gap-5 mt-5">
          ...
          <div class="flex flex-col justify-center items-center p-4">
            <img src="{{ isset($user->dosen) && $user->dosen->foto ? asset('storage/' . $user->dosen->foto) : asset('images/profil-kosong.png') }}" id="previewImage" class="w-40 h-40 mb-4 hover:border-2 border-white border-2 hover:border-gray-300 active:border-gray-400 rounded-full object-cover" alt="Preview Foto">
          ...
          <div class=" px-8 py-4 flex justify-end">
              {{-- <a href="{{route('dosen.master-dosen.index')}}" class="px-5 py-2 mr-2 bg-red-500 hover:bg-red-600 active:bg-red-700 text-white font-semibold rounded-md cursor-pointer">Batal</a> --}}
          ...
          <div class="px-8 py-4">
            <div class="flex flex-col md:flex-row mb-4">
              <div class="flex flex-col w-full">
                ...
                <input type="text" disabled class="p-2 border-2 border-gray-700 bg-gray-100 text-gray-700 rounded-sm" value="{{old('nama', $user->dosen->nama ?? '')}}">
              </div>
            </div>
            <div class="flex flex-col md:flex-row">
              ...
              <div class="flex flex-col w-full mb-4">
                ...
                <input type="text" disabled class="p-2 border-2 border-gray-700 bg-gray-100 text-gray-700 rounded-sm" value="{{$user->dosen->agama ?? ''}}">
              </div>
            </div>
            <div class="flex flex-col md:flex-row">
              <div class="flex flex-col w-full mb-4 mr-0 md:mr-4">
                <label for="" class="mb-1 font-semibold text-gray-600">Tempat Tanggal Lahir:</label>
                <input type="text" disabled class="p-2 border-2 border-gray-700 bg-gray-100 text-gray-700 rounded-sm" value="{{$user->dosen->tempat_lahir .', '. $user->dosen->tgl_lahir}}">
              </div>
              <div class="flex flex-col w-full mb-4">
                <label for="" class="mb-1 font-semibold text-gray-600">Jenis Kelamin:</label>
                <input type="text" disabled class="p-2 border-2 border-gray-700 bg-gray-100 text-gray-700 rounded-sm" value="{{$user->dosen->jenis_kelamin}}">
              </div>
            </div>
            <div class="flex flex-col md:flex-row mb-4">
              <div class="flex flex-col w-full">
                <label for="" class="mb-1 font-semibold text-gray-600">Email:</label>
                <input type="text" disabled class="p-2 border-2 border-gray-700 bg-gray-100 text-gray-700 rounded-sm" value="{{$user->dosen->email}}">
              </div>
            </div>
            <div class="flex flex-col md:flex-row">
              <div class="flex flex-col w-full mb-4 mr-0 md:mr-4">
                <label for="" class="mb-1 font-semibold text-gray-600">No Telp:</label>
                <input type="text" disabled class="p-2 border-2 border-gray-700 bg-gray-100 text-gray-700 rounded-sm" value="{{$user->dosen->no_telp}}">
              </div>
              <div class="flex flex-col w-full mb-4">
                <label for="" class="mb-1 font-semibold text-gray-600">Alamat:</label>
                <input type="text" disabled class="p-2 border-2 border-gray-700 bg-gray-100 text-gray-700 rounded-sm" value="{{$user->dosen->province->name .', '. $user->dosen->regency->name .', '. $user->dosen->district->name .', '. $user->dosen->village->nama .', '. $user->dosen->alamat  }}">
              </div>
            </div>
