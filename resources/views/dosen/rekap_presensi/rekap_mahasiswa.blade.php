    ...
    <div class="h-full dark:bg-gray-700 dark:text-white">
            ...
            <form action="{{ route('dosen.rekap-mahasiswa.filter') }}" method="post">
                ...
                <div class="flex flex-col xl:flex-row">
                    <div class="flex flex-col w-full mb-4 xl:w-1/3 mr-0 md:mr-4">
                        ...
                        <select id="prodi-dosen" name="prodi" class="dark:bg-gray-700 dark:text-white dark:border-gray-600">
                    ...
                    <div class="flex flex-col w-full mb-4 xl:w-1/3 mr-0 md:mr-4">
                        ...
                        <select id="semester-dosen" name="semester" class="dark:bg-gray-700 dark:text-white dark:border-gray-600">
                    ...
                    <div class="flex flex-col w-full mb-4 xl:w-1/3">
                        ...
                        <select id="matkul" name="matkul" class="dark:bg-gray-700 dark:text-white dark:border-gray-600">
                        </select>
                    </div>
                </div>

                <div class="w-full flex justify-end">
                    <a href="{{ route('dosen.rekap-mahasiswa.index') }}"
        ...
        <div class="w-full h-max max-w-full mt-5 p-8 bg-white dark:bg-gray-800 rounded-sm shadow-xl">
            @if ($prodiTerpilih && $matkulTerpilih && $semesterTerpilih)
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3 my-5">
                    <div class="flex flex-col md:flex-row items-start md:items-center gap-2">
                        <label class="w-40 font-semibold">Program Studi:</label>
                        <span class="border border-gray-300 bg-gray-300 dark:bg-gray-700 dark:border-gray-600 rounded px-3 py-2 w-full">
                            {{ $prodiTerpilih->nama_prodi ?? '' }}
                        </span>
                    </div>
                
                    <div class="flex flex-col md:flex-row items-start md:items-center gap-2">
                        <label class="w-40 font-semibold">Semester:</label>
                        <span class="border border-gray-300 bg-gray-300 dark:bg-gray-700 dark:border-gray-600 rounded px-3 py-2 w-full">
                            {{ $semesterTerpilih ?? '' }}
                        </span>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-center gap-2">
                        <label class="w-40 font-semibold">Mata Kuliah:</label>
                        <span class="border border-gray-300 bg-gray-300 dark:bg-gray-700 dark:border-gray-600 rounded px-3 py-2 w-full">
            ...
            <div x-data="{ hovering: false }" class="overflow-x-auto w-60 sm:w-150 md:w-240 xl:min-w-full pb-3">
                <table id="data-rekap-mahasiswa"
                    class="text-sm w-full border border-gray-300 dark:border-gray-600 text-left dark:text-gray-100 dark:bg-gray-800">
                    <thead class="bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-100 sticky top-0 z-10">
                        <tr>
                            ...
                            <th @mouseenter="hovering = true" @mouseleave="hovering = false"
                                ...
                                class="border border-gray-300 dark:border-gray-600 px-4 py-2 transition-colors duration-200">
                                Nim
                            </th>
                                    ...
                                    @for ($i = 1; $i <= $totalPertemuan; $i++)
                                        @php
                                            ...
                                            switch ($status) {
                                                ...
                                                case 'I': $bg = 'bg-yellow-400'; break;
                                                case 'S': $bg = 'bg-blue-400'; break;
                                                case 'A': $bg = 'bg-red-500'; break;
                                                default:  $bg = 'bg-gray-400'; break;
                                            }
                                        @endphp
                                        <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 font-semibold text-white {{ $bg }}"
                                            title="{{ $tanggal . ' ' . $dosen }}">
                                            {{ $status }}
                                        </td>
                                    @endfor
