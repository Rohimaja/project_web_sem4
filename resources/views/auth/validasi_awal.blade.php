...
>>>>>>> c0e2562 (first commit)
              ...
              <div>
                  ...
                  <input type="text" name="email" id="email" required
                      class="mt-1 w-full px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Masukkan email...">
<<<<<<< HEAD
=======
