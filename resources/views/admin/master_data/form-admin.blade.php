            ...
            <form id="form-admin" action="{{ isset($admin) ? route('admin.master-admin.update', $admin->id) : route('admin.master-admin.store') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="flex flex-col w-full mb-4 md:w-1/2 mr:0 md:mr-8">
                        ...
                        <input type="text" class="p-2 border-2 border-gray-400 dark:border-gray-600  bg-white dark:bg-gray-700 text-black dark:text-white rounded-sm" name="nama" id="nama" value="{{old('nama', $admin->nama ?? '')}}" required data-validate="admin" placeholder="Masukkan nama lengkap">
                    ...
                    <div class="flex flex-col w-full mb-4 md:w-1/2">
                        ...
                        <input type="text" class="p-2 border-2 border-gray-400 dark:border-gray-600  bg-white dark:bg-gray-700 text-black dark:text-white rounded-sm" name="no_telp" id="no_telp" value="{{old('no_telp', $admin->no_telp ?? '')}}" data-validate="admin" required placeholder="Masukkan no telp">
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="flex flex-col w-full mb-4 md:w-1/2 mr:0 md:mr-8">
                        ...
                        <input type="text" class="p-2 border-2 border-gray-400 dark:border-gray-600  bg-white dark:bg-gray-700 text-black dark:text-white rounded-sm" name="tempat_lahir" id="tempat_lahir" value="{{old('tempat_lahir', $admin->tempat_lahir ?? '')}}" required data-validate="admin" placeholder="Masukkan Tempat Lahir">
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="flex flex-col w-full mb-4 md:w-1/2 mr:0 md:mr-8">
                        ...
                        <input type="email" class="p-2 border-2 border-gray-400 dark:border-gray-600  bg-white dark:bg-gray-700 text-black dark:text-white rounded-sm" name="email" id="email" value="{{old('email', $admin->email ?? '')}}" required data-validate="admin" placeholder="Masukkan Email">
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="flex flex-col w-full mb-4 md:w-1/2 mr:0 md:mr-8">
                        ...
                        <select id="provinsi" name="province_id" data-selected="{{$admin->province_id ?? ''}}" class="p-2 mt-1 py-[10.5px] w-full flex border-2 font-normal border-gray-400 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-sm" required>
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="flex flex-col w-full mb-4 md:w-1/2 mr:0 md:mr-8">
                        ...
                        <select id="kecamatan" name="district_id" data-selected="{{$admin->district_id ?? ''}}" class="p-2 mt-1 py-[10.5px] w-full flex border-2 font-normal border-gray-400 dark:border-gray-600  bg-white dark:bg-gray-700 text-black dark:text-white rounded-sm" required>
                    ...
                    <div class="flex flex-col w-full mb-4 md:w-1/2">
                        ...
                        <select id="kelurahan" name="village_id" data-selected="{{$admin->village_id ?? ''}}" class="p-2 py-[11px] w-full flex border-2 font-normal border-gray-400 dark:border-gray-600  bg-white dark:bg-gray-700 text-black dark:text-white rounded-sm" required>
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="flex flex-col w-full mb-4 md:w-1/2 mr:0 md:mr-8">
                        ...
                        <textarea type="text" class="p-2 mt-1 py-[10.5px] w-full flex border-2 font-normal border-gray-400 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-sm" name="alamat" id="alamat" required data-validate="admin" placeholder="Masukkan Alamat Lengkap">{{$admin->alamat ?? ''}}</textarea>
