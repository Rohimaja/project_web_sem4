                  ...
                  <div x-data="{openView: false}">
                    ...
                    <div x-show="openView"  x-cloak x-transition class="fixed inset-0 z-50 flex justify-center items-center">
                      ...
                      <div @click.outside="openView = false" class="relative z-10 bg-white rounded-sm shadow-xl sm:w-[500px] w-[305px] h-[600px] max-w-full p-6 overflow-y-scroll">
                        <div class="flex justify-between items-center mb-4">
                          <h1 class="text-gray-600 text-xl font-semibold">View Data Mata Kuliah</h1>
                        ...
                        <div class="flex flex-col md:flex-row">
                          <div class="flex flex-col items-start w-full mb-4 md:w-1/2 mr-0 md:mr-8">
                            ...
                            <input type="text" disabled class="bg-gray-100 w-full p-2 border-2 border-gray-700 rounded-sm" value="ENG23">
                          </div>
                          <div class="flex flex-col items-start w-full mb-4 md:w-1/2">
                            <label for="" class="mb-1 font-semibold">Nama Mata Kuliah:</label>
                            <input type="text" disabled class="bg-gray-100 w-full p-2 border-2 border-gray-700 rounded-sm" value="English">
                          </div>
                        </div>
                        <div class="flex flex-col md:flex-row">
                          <div class="flex flex-col items-start w-full mb-4 md:w-1/2 mr-0 md:mr-8">
                            <label for="" class="mb-1 font-semibold">Sks:</label>
                            <input type="text" disabled class="bg-gray-100 w-full p-2 border-2 border-gray-700 rounded-sm" value="14">
                          </div>
                          <div class="flex flex-col items-start w-full mb-4 md:w-1/2">
                            <label for="" class="mb-1 font-semibold">Jenis Mata Kuliah:</label>
                            <input type="text" disabled class="bg-gray-100 w-full p-2 border-2 border-gray-700 rounded-sm" value="Wajib">
                          </div>
                        </div>
                        <div class="flex flex-col md:flex-row">
                          <div class="flex flex-col items-start w-full mb-4 md:w-1/2 mr-0 md:mr-8">
                            <label for="" class="mb-1 font-semibold">Dosen Pengampu:</label>
                            <input type="text" disabled class="bg-gray-100 w-full p-2 border-2 border-gray-700 rounded-sm" value="Sudarsono">
                          </div>
                          <div class="flex flex-col items-start w-full mb-4 md:w-1/2">
