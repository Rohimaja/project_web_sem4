        ...
        <table id="myTable" class="text-sm text-left w-full pt-2">
          ...
          <tbody class="">
            ...
            <tr class="hover:bg-gray-50">
              ...
              <td class="border border-gray-300 px-4 py-2">{{$m->prodi->nama_prodi ?? ''}}</td>
              ...
              <td class="border border-gray-300 px-4 py-2 text-center">
                <div class="flex justify-center gap-2">
                    <a href="{{route('admin.master-matkul.edit', $m->id)}}" class="px-2 py-1 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white rounded-md">
