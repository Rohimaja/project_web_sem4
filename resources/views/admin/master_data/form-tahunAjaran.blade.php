  ...
  <div class="h-full">
    ...
    <div class="w-full h-max max-w-full mt-5 p-8 bg-white rounded-sm shadow-xl">
      ...
      <form action="">
        ...
        <div class="flex flex-col md:flex-row">
          <div class="flex flex-col w-full mb-4 md:w-1/2 mr-8">
            ...
            <input type="number" min="2000" max="2099" class="p-2 border-2 border-gray-700 rounded-sm" placeholder="Masukkan Tahun Mulai">
          </div>
          <div class="flex flex-col w-full mb-4 md:w-1/2">
            <label for="" class="mb-1 font-semibold">Tahun Selesai:</label>
            <input type="number" min="2000" max="2099" class="p-2 border-2 border-gray-700 rounded-sm" placeholder="Masukkan Tahun Selesai">
          </div>
        </div>
      ...
      <div>
        ...
        <a href="/admin/masterdata/tahunAjaran">
