    ...
    <div class="w-full h-max max-w-full mt-5 p-8 bg-white rounded-sm shadow-xl">
        ...
        <div class="flex flex-col md:flex-row">
          <div class="flex flex-col w-full mb-4 md:w-1/2 mr-8">
            ...
            <input list="tahun-list" name="tahun_awal" class="p-2 border-2 border-gray-700 rounded-sm" id="tahun_awal" placeholder="Masukkan Tahun Awal" value="{{old('tahun_awal', $tahun->tahun_awal ?? '')}}">
          ...
          <div class="flex flex-col w-full mb-4 md:w-1/2">
            ...
            <input list="tahun-list" name="tahun_akhir" class="p-2 border-2 border-gray-700 rounded-sm" id="tahun_akhir" value="{{old('tahun_akhir', $tahun->tahun_akhir ?? '')}}" placeholder="Masukkan Tahun Akhir">
            <datalist id="tahun-list">
                @for($i = date('Y'); $i >= 2000; $i--)
                    <option value="{{ $i }}">
                @endfor
        ...
        <div class="flex flex-col md:flex-row">
          <div class="flex flex-col w-full mb-4 md:w-1/2 mr-8">
            ...
            <select type="text" class="p-2 mt-1 py-[10.5px] w-full flex border-2 font-normal border-gray-700 rounded-sm" name="keterangan" id="keterangan">
