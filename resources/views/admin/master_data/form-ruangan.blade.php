...
=======
                <div class="w-full">
                    <div class="flex flex-col w-full mb-4">
                        <label for="" class="mb-1 font-semibold">Nama Ruangan:</lab>
                        <input type="text" class="p-2 mt-1 w-full flex border-2 font-normal border-gray-400 rounded-sm" name="nama_ruangan" id="nama_ruangan" value="{{old('nama_ruangan', $ruangan->nama_ruangan ?? '')}}" required data-validate="ruangan" >
...
=======
                <div class="w-full flex justify-end mt-7">
                    <a href="{{ route('admin.master-ruangan.index') }}" class="inline-block px-5 py-2 mr-2 bg-red-500 hover:bg-red-600 active:bg-red-700 text-white font-semibold rounded-md cursor-pointer">
                        Batal
                    </a>
