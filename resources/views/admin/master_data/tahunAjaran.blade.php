                    ...
                    <tbody class="">
                        @foreach ($tahun as $t )
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="border border-gray-300 px-4 py-2">{{$t->tahun_awal. '/' .$t->tahun_akhir}}</td>
                                <td class="border border-gray-300 px-4 py-2">{{$t->keterangan}}</td>
                                <td class="border border-gray-300 px-4 py-2">
                                    ...
                                    @else
                                        <span class="text-gray-800 px-3 py-1 rounded-full text-xs font-semibold">Unknown</span>
                                    @endif
                                </td>
