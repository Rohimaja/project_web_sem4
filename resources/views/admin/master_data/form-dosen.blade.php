            ...
            <form action="{{ isset($dosen) ? route('admin.master-dosen.update', $dosen->id) : route('admin.master-dosen.store') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="flex flex-col w-full mb-4 md:w-1/2 mr-0 md:mr-8">
                        ...
                        <input type="text" class="p-2 border-2 border-gray-400 dark:border-gray-600 rounded-sm bg-white dark:bg-gray-700 text-black dark:text-white " name="nama" id="nama" value="{{old('nama', $dosen->nama ?? '')}}" required data-validate="dosen" placeholder="Masukkan nama lengkap">
                    ...
                    <div class="flex flex-col w-full mb-4 md:w-1/2">
                        ...
                        <input type="text" class="p-2 border-2 border-gray-400 dark:border-gray-600 rounded-sm bg-white dark:bg-gray-700 text-black dark:text-white " name="nip" id="nip" value="{{old('nip', $dosen->nip ?? '')}}" required data-validate="dosen" placeholder="Masukkan NIP">
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="flex flex-col w-full mb-4 md:w-1/2 mr-0 md:mr-8">
                        ...
                        <input type="text" class="p-2 border-2 border-gray-400 dark:border-gray-600  bg-white dark:bg-gray-700 text-black dark:text-white rounded-sm" name="tempat_lahir" id="tempat_lahir" value="{{old('tempat_lahir', $dosen->tempat_lahir ?? '')}}" required data-validate="dosen" placeholder="Masukkan Tempat Lahir">
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="flex flex-col w-full mb-4 md:w-1/2 mr-0 md:mr-8">
                        ...
                        <input type="email" class="p-2 border-2 border-gray-400 dark:border-gray-600  bg-white dark:bg-gray-700 text-black dark:text-white rounded-sm" name="email" id="email" value="{{old('email', $dosen->email ?? '')}}" required data-validate="dosen" placeholder="Masukkan Email">
                    ...
                    <div class="flex flex-col w-full mb-4 md:w-1/2">
                        ...
                        <input type="text" class="p-2 border-2 border-gray-400 dark:border-gray-600  bg-white dark:bg-gray-700 text-black dark:text-white rounded-sm" name="no_telp" id="no_telp" value="{{old('no_telp', $dosen->no_telp ?? '')}}" required data-validate="dosen" placeholder="Masukkan no telp">
