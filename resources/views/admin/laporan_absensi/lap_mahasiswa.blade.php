<x-layout>
  <div class="h-full">
    ...
    <p>Lihat Laporan Presensi Mahasiswa </p>
      ...
      <div class="flex flex-col xl:flex-row">
        ...
        <div class="flex flex-col w-full mb-4 xl:w-1/3"
             x-data="{
                ...
                selected: '',
                loading: false,
                options: ['Islam', 'Hindu', 'Buddha', 'Kristen', 'Konghucu'],
                get filtered() {
                  return this.options.filter(o => o.toLowerCase().includes(this.search.toLowerCase()));
                }
             }">
          <label class="mb-1 font-semibold">Filter Mata Kuliah:</label>
...
>>>>>>> 8934609 (fixed responsive & view  admin)
            ...
            <tbody class="text-center">
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="border border-gray-300 px-4 py-2">Suryono</td>
