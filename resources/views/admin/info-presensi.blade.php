<x-layout>
    <div class="h-full">
      ...
      <p class="text-gray-700 dark:text-white">Tinjau detail kehadiran perkuliahan Hari Ini</p>
      ...
      <div class="w-full overflow-x-auto max-w-full mt-5 p-5 bg-white dark:bg-gray-800 rounded-sm shadow-xl">
        ...
        <div class="overflow-x-auto w-[270px] sm:w-150 md:w-full mt-3 pb-3">
          <table id="tbl-pres" class="text-sm text-left w-full pt-2 text-gray-800 dark:text-gray-100">
                        ...
                        <div @click.outside="openEdit = false" class="relative z-10 bg-white dark:bg-gray-900 rounded-lg shadow-2xl w-[90%] max-w-md p-6">
                          <div class="flex justify-center mb-4">
                            <div class="bg-blue-100 dark:bg-blue-900 rounded-full p-4">
                              <i class="bi bi-pencil-square text-4xl text-blue-600 dark:text-blue-300"></i>
                            </div>
                          </div>
                          ...
                          <div class="flex flex-wrap justify-center gap-4 mb-6">
                            <label class="inline-flex items-center">
                              ...
                              <span class="ml-2 text-gray-700 dark:text-white">Hadir</span>
                            </label>
                            <label class="inline-flex items-center">
                              <input type="radio" name="status" value="2" class="form-radio text-gray-500" x-model="status">
                              <span class="ml-2 text-gray-700 dark:text-white">Izin</span>
                            </label>
                            <label class="inline-flex items-center">
                              <input type="radio" name="status" value="3" class="form-radio text-yellow-500" x-model="status">
                              <span class="ml-2 text-gray-700 dark:text-white">Sakit</span>
                            </label>
                            <label class="inline-flex items-center">
                              <input type="radio" name="status" value="0" class="form-radio text-red-600" x-model="status">
                              <span class="ml-2 text-gray-700 dark:text-white">Alpha</span>
                            </label>
                          </div>
                          <div class="mb-6 w-full">
                            <label for="alasan" class="block text-gray-700 dark:text-white mb-1">Alasan:</label>
                            <textarea id="alasan" name="alasan" rows="3" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" x-bind:disabled="!(status == 2 || status == 3)"></textarea>
                          </div>
                          <div class="flex justify-end space-x-3">
                            <button type="button" @click="openEdit = false" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 dark:text-white rounded hover:bg-gray-300 dark:hover:bg-gray-600">Batal</button>
