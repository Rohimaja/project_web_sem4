      ...
      <p class="text-gray-700 dark:text-white">Tinjau Detail Kehadiran Perkuliahan</p>
        ...
        <div class="w-full overflow-x-auto max-w-full mt-5 p-5 bg-white dark:bg-gray-800 rounded-sm shadow-xl">
            ...
            <div class="overflow-x-auto w-[270px] sm:w-150 md:w-full mt-3 pb-3">
                <table id="detail-presensi" class="text-sm text-left w-full pt-2 text-gray-800 dark:text-gray-100" width="100%">
                                            ...
                                            <div x-show="openEdit" x-cloak x-transition class="fixed inset-0 z-50 flex justify-center items-center">
                                                ...
                                                <div @click.outside="openEdit = false" class="relative z-10 bg-white dark:bg-gray-900 rounded-lg shadow-2xl w-[90%] max-w-md p-6">
                                                    ...
                                                    <div class="mb-6 w-full">
                                                        ...
                                                        <textarea id="alasan" name="alasan" rows="3" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" x-bind:disabled="!(status == 2 || status == 3)">{{$dp->alasan}}</textarea>
                                                    </div>
