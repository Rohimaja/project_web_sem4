    ...
    <div class="flex flex-col md:flex-row gap-5">
      <div class="w-[310px] md:w-3/4 bg-white dark:bg-gray-800 rounded-sm shadow-xl">
        <div class="mb-3 p-4 rounded-t-xl border-b-2 border-gray-300 dark:border-gray-600 flex justify-between items-center flex-wrap gap-2">
          <h1 class="text-gray-500 dark:text-white text-lg font-semibold">Daftar Dosen Mengajar Hari Ini</h1>
          <input type="text" id="searchInput" placeholder="Cari dosen..." class="w-full md:w-[200px] text-sm border border-gray-300 dark:border-gray-600 rounded-md px-3 py-1 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-400">
        </div>
