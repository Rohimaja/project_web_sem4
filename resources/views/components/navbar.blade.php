<nav class="fixed z-50 xl:sticky top-0 w-full border-b border-gray-300 bg-gradient-to-r from-blue-900 to-blue-900 p-4 px-4 z-10">
  <div class="flex justify-between items-center">
    ...
    <div x-data="{open: false}" class="flex items-center gap-3">
      ...
      <div @click="open = !open" @click.away="open = false" class="flex gap-3 items-center cursor-pointer">
        ...
        <h3 class="text-white hidden md:block">Syalia Ayu <i class="bi bi-chevron-down"></i></h3>
      </div>
