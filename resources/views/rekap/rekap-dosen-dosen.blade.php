<x-layout>
    ...
    <div class="h-full dark:bg-bgDark dark:text-gray-100">
            ...
            <form action="{{ route('admin.rekap-dosen.filter') }}" method="POST">
                ...
                <div class="flex flex-col md:flex-row">
                    <div class="flex flex-col w-full mb-4 md:w-1/2 mr-0 md:mr-8">
                        ...
                        <select id="dosen" name="dosen" class="dark:bg-gray-700 dark:text-white">
                    ...
                    <div class="flex flex-col w-full mb-4 md:w-1/2 mr-0">
                        ...
                        <select id="tahun-ajaran" name="tahun_ajaran" class="w-full dark:bg-gray-700 dark:text-white">
                            <option value="" hidden selected>Pilih Tahun Ajaran</option>
                            @foreach ($tahun as $t)
                                <option value="{{ $t->id }}">{{ $t->tahun_awal . '/' . $t->tahun_akhir . ' ' . $t->keterangan }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="w-full flex justify-end">
                    <a href="{{ route('dosen.rekap-dosen.index') }}"
        ...
        <div class="w-full h-max max-w-full mt-5 p-8 bg-white dark:bg-gray-800 rounded-sm shadow-xl">
            ...
            <div x-data="{ hovering: false }"
                class="overflow-x-auto w-60 sm:w-150 md:w-240 xl:min-w-full mt-1 pb-3">
                <table id="data-rekap-dosen"
                    class="text-sm text-left w-full pt-4 display nowrap dark:text-white">
                    <thead class="bg-gray-200 dark:bg-gray-700 dark:text-white text-gray-700 sticky top-0 z-10">
                        <tr>
