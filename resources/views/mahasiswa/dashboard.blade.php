      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 h-full">
        ...
        <div class="flex flex-col items-center text-sm text-gray-700 dark:text-gray-300 space-y-4">
          ...
          <div class="w-full space-y-3">
            <div class="flex justify-between"><span class="font-medium text-gray-500 dark:text-gray-400">Nama:</span><span class="text-right">Nama Mahasiswa</span></div>
            <div class="flex justify-between"><span class="font-medium text-gray-500 dark:text-gray-400">NIM:</span><span class="text-right">12345678</span></div>
            <div class="flex justify-between"><span class="font-medium text-gray-500 dark:text-gray-400">Program Studi:</span><span class="text-right">Manajemen Informatika</span></div>
            <div class="flex justify-between"><span class="font-medium text-gray-500 dark:text-gray-400">Semester:</span><span class="text-right">2</span></div>
            <div class="flex justify-between"><span class="font-medium text-gray-500 dark:text-gray-400">Email:</span><span class="text-right">mahasiswa@email.com</span></div>
            <div class="flex justify-between"><span class="font-medium text-gray-500 dark:text-gray-400">No. Telepon:</span><span class="text-right">0812-3456-7890</span></div>
            <div class="flex justify-between"><span class="font-medium text-gray-500 dark:text-gray-400">Jenis Kelamin:</span><span class="text-right">Laki-laki</span></div>
            <div class="flex justify-between"><span class="font-medium text-gray-500 dark:text-gray-400">Tanggal Lahir:</span><span class="text-right">1 Januari 2003</span></div>
            <div class="flex justify-between"><span class="font-medium text-gray-500 dark:text-gray-400">Alamat:</span><span class="text-right">Jl. Mawar No. 10, Jember</span></div>
          </div>
        </div>
      </div>
